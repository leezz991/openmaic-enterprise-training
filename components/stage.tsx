...
export function Stage({
  ...
  const resolvedBackHref = backHref ?? (isLearnerShell ? '/courses' : '/');
  const resolvedBrandHref = brandHref ?? resolvedBackHref;
  ...
  return (
    ...
    >
      ...
      <SceneSidebar
        ...
        brandAlt={brandAlt}
        brandTitle={isLearnerShell ? 'Back to course list' : undefined}
      />
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0 relative">
        ...
        {!isPresenting && (
          <Header
            ...
            backTitle={isLearnerShell ? 'Back to course list' : undefined}
            showPersist={!isLearnerShell}
            showExport={!isLearnerShell}
            showLanguageSwitcher={!isLearnerShell}
            showThemeSwitcher={!isLearnerShell}
            showSettings={!isLearnerShell}
            portalHref={isLearnerShell ? undefined : '/courses'}
          />
        )}
